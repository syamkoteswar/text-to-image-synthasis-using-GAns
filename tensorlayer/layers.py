...
class Word2vecEmbeddingInputlayer(Layer):
    ...
    def __init__(
        ...
        num_sampled = 64,
        nce_loss_args = {},
        E_init = tf.compat.v1.random_uniform_initializer(minval=-1.0, maxval=1.0),
        E_init_args = {},
        nce_W_init = tf.compat.v1.truncated_normal_initializer(stddev=0.03),
        nce_W_init_args = {},
        nce_b_init = tf.compat.v1.constant_initializer(value=0.0),
        nce_b_init_args = {},
        name ='word2vec_layer',
    ):
...
def Conv2d(net, n_filter=32, filter_size=(3, 3), strides=(1, 1), act = None,
        padding='SAME', W_init = tf.compat.v1.truncated_normal_initializer(stddev=0.02), b_init = tf.compat.v1.constant_initializer(value=0.0),
...
def DeConv2d(net, n_out_channel = 32, filter_size=(3, 3),
        ...
        W_init = tf.compat.v1.truncated_normal_initializer(stddev=0.02), b_init = tf.compat.v1.constant_initializer(value=0.0),
...
class BatchNormLayer(Layer):
    ...
    def __init__(
        ...
        with tf.compat.v1.variable_scope(name) as vs:
            ...
            mean, variance = tf.compat.v1.nn.moments(self.inputs, axis)
            try:    # TF12
